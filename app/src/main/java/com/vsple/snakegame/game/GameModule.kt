...
/*
This composable hold the game logic
It contain starting size of snake, starting direction
This also hold the coordinate of the snake food and snake its self
so we can decide where the snake and its food land on board
 */
class GameModule(
